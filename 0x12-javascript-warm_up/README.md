...
[5-to_integer.js](./5-to_integer.js) | JS script that prints My number: number if the first argument can be converted to an integer
...
[7-multi_c.js](./7-multi_c.js) | JS script that prints x times
...
[103-object_fct.js](./103-object_fct.js) | JS script that adds a new function incr that increments the integer value
